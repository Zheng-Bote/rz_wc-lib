      ...
      function findRec(currentPath) {
        ...
        function process(fileInfos) {
          ...
          if (res.markdownFiles.length > 0)
            console.log(
              '\nFound %s in "%s"',
              _(res.markdownFiles).pluck("name").join(", "),
              currentPath
            );
...
*/
      ...
      var go = (module.exports = function (lines, maxHeaderLevel) {
        var source = md
          ...
          .children.filter(function (node) {
            return (
              node.type === md.Syntax.HtmlBlock || node.type === md.Syntax.Html
            );
          })
          .map(function (node) {
            return node.raw;
        ...
        var parser = new htmlparser.Parser(
          {
            ...
            ontext: function (text_) {
              ...
              if (
                grabbing.length === 0 ||
                grabbing[grabbing.length - 1] === "pre"
              )
                return;
    ...
    /***/ 1644: /***/ (module, exports, __nccwpck_require__) => {
      "use strict";
      ...
      exports = module.exports = function transform(
        content,
        mode,
        maxHeaderLevel,
        title,
        ...
        var currentToc =
            info.hasStart &&
            lines.slice(info.startIdx, info.endIdx + 1).join("\n"),
        ...
        var toc =
          ...
          linkedHeaders
            .map(function (x) {
              var indent = _(_.range(x.rank - lowestRank)).reduce(function (
                acc,
                x
              ) {
        ...
        (0, traverse_1.default)(ast).forEach(function (node) {
          ...
          if (this.notLeaf) {
            if (node.type) {
              ...
              if (!replacedType) {
                debug(
                  `replacedType : ${replacedType} , node.type: ${node.type}`
                );
              } else {
    ...
    /***/ 4805: /***/ function (
      ...
      const remark = (0, unified_1.default)()
    ...
    /***/ 2600: /***/ (
       ...
       */
      module.exports = function anchorMarkdownHeader(
        header,
        mode,
        repetition,
        moduleName
        ...
        switch (mode) {
          ...
          case "nodejs.org":
            if (!moduleName)
              throw new Error(
                "Need module name to generate proper anchor for " + mode
              );
    ...
    /***/ 1227: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 6970: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 7359: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 7335: /***/ (
      ...
      function create(EConstructor) {
        FormattedError.displayName =
          EConstructor.displayName || EConstructor.name;
        ...
        Parser.prototype.onclosetag = function (name) {
          ...
          if (!this.isVoidElement(name)) {
            ...
            (_d = (_c = this.cbs).onopentag) === null || _d === void 0
              ? void 0
              : _d.call(_c, name, {}, true);
            (_f = (_e = this.cbs).onclosetag) === null || _f === void 0
              ? void 0
              : _f.call(_e, name, false);
          }
          // Set `startIndex` for next node
          this.startIndex = this.endIndex + 1;
        };
      ...
      var Tokenizer = /** @class */ (function () {
        function Tokenizer(_a, cbs) {
          ...
          this.entityTrie = xmlMode
            ? decode_1.xmlDecodeTree
            : decode_1.htmlDecodeTree;
        }
        ...
        Tokenizer.prototype.stateInNamedEntity = function (c) {
          this.entityExcess += 1;
          this.trieIndex = (0, decode_1.determineBranch)(
            this.entityTrie,
            this.trieCurrent,
            this.trieIndex + 1,
            c
    ...
    /***/ 7339: /***/ (__unused_webpack_module, exports) => {
    ...
    /***/ 6247: /***/ (__unused_webpack_module, exports) => {
    ...
    /***/ 1464: /***/ (__unused_webpack_module, exports) => {
      exports.enter = {
        table: enterTable,
        tableData: enterCell,
    ...
    /***/ 8442: /***/ (__unused_webpack_module, exports) => {
      exports.exit = {
    ...
    /***/ 9163: /***/ (module) => {
      module.exports = function (md, options) {
        ...
        options.replaceLinksWithURL = options.hasOwnProperty(
          "replaceLinksWithURL"
        )
    ...
    /***/ 4149: /***/ (
      ...
      var argv = minimist(process.argv.slice(2), {
        ...
        unknown: function (a) {
          return a[0] == "-"
            ? (console.error("Unknown option(s): " + a),
      ...
      if ((maxHeaderLevel && isNaN(maxHeaderLevel)) || maxHeaderLevel < 0) {
        console.error(
          "Max. heading level specified is not a positive number: " +
            maxHeaderLevel
        ),
          printUsageAndExit(true);
      }
    ...
    /***/ 6717: /***/ (__unused_webpack_module, exports) => {
