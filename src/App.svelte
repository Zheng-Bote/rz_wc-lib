<script lang="ts">
  ...
  import RzOnline from './lib/rz-online.svelte';
...
<span id="top"></span>
  <div id="rz_button_top">
    <RzButtonTop></RzButtonTop>
  </div>
...
<div class="content">
  ...
  <h2>Online</h2>
<RzOnline with_text="yes"></RzOnline>
<br/>
<main>

<article>
  <h2>Login</h2>
  <RzLoginForm></RzLoginForm>
</article>
...
.content{
  ...
  margin: calc(var(--base-padding) * 4);
}
</style>
